...
<!-- Modal Overlay -->
	...
	<!-- Modal Content -->
	<div
		class="relative w-full max-w-md rounded-2xl border border-gray-800 bg-black shadow-2xl"
		role="document"
	>
		<!-- Close Button -->
		<button
			on:click={closeModal}
			class="absolute top-4 right-4 z-10 text-gray-400 transition-colors duration-200 hover:text-white"
		...
		<!-- Form Header -->
		<div class="border-b border-gray-800 px-6 py-6">
		...
		<!-- Form -->
		<form on:submit|preventDefault={handleSubmit} class="space-y-6 px-6 py-6">
			<!-- Name Field -->
			<div>
			...
			<div class="pt-4">
				<button
					...
					class="flex w-full items-center justify-center rounded-lg bg-orange-500 px-6 py-3 font-medium text-white transition-colors duration-200 hover:bg-orange-600 disabled:cursor-not-allowed disabled:bg-orange-400"
				>
					{#if isSubmitting}
						<svg
...
{#if showConfirmation}
	<div
		class="bg-opacity-50 fixed inset-0 z-[60] flex items-center justify-center bg-black p-4"
		...
		>
			...
			<div class="px-6 py-8 text-center">
				...
				<div class="flex flex-col gap-3 sm:flex-row">
					<button
						on:click={closeConfirmation}
						class="flex-1 rounded-lg border border-gray-700 bg-gray-900 px-6 py-3 font-medium text-white transition-colors duration-200 hover:bg-gray-800"
					>
						Submit Another Form
					</button>
					<button
						on:click={closeFormAfterConfirmation}
						class="flex-1 rounded-lg bg-orange-500 px-6 py-3 font-medium text-white transition-colors duration-200 hover:bg-orange-600"
					>
						Close
					</button>
				</div>
