                        ...
                        <tr class="modal-table-row">
                            <td class="px-1 md:px-4 py-2 md:py-4 text-xs md:text-sm font-bold text-gray-900 backdrop-blur-sm">
                                <div class="flex items-center space-x-1 md:space-x-2">
                                    ...
                                    <span class="hidden sm:inline">Pay After Placement</span>
                                    <span class="sm:hidden">Pay After Place</span>
                                </div>
                            </td>
                            {#each universities as university}
                                <td class="px-1 md:px-4 py-2 md:py-4 text-xs md:text-sm font-semibold text-gray-700 backdrop-blur-sm">{university.payAfterPlacement}</td>
                            {/each}
                        </tr>
                        <tr class="modal-table-row-alt">
                            <td class="px-1 md:px-4 py-2 md:py-4 text-xs md:text-sm font-bold text-gray-900 backdrop-blur-sm">
