...
<main class="min-h-screen flex flex-col">
  <div class="relative">
    <HeroSection images={shooliniImages}>
      <div class="text-center max-w-4xl px-4">
        <div class="inline-block text-black px-6 py-2 rounded-full mb-4 font-bold text-xl shadow-lg" style="background-color: #edcc13;">PAY-AFTER-PLACEMENT</div>
        ...
        <p class="text-3xl md:text-4xl font-bold mb-6" style="color: #edcc13;">FROM INDIA'S NO. 1 PRIVATE UNIVERSITY</p>
        ...
        <button
          on:click={openForm}
          class="text-white px-8 py-3 rounded-full font-medium text-lg transition-colors duration-200 inline-block hover:bg-[#d4b312]"
    ...
    <div class="container mx-auto px-4">
      ...
      <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
        ...
        <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
          <div class="w-12 h-12 bg-[#f7f3e3] rounded-lg flex items-center justify-center mb-4">
            <svg class="w-6 h-6" fill="none" stroke="#edcc13" viewBox="0 0 24 24">
  ...
  <section class="py-16 bg-gray-50">
    <div class="container mx-auto px-4">
      <div class="text-center mb-12">
        <h2 class="text-3xl md:text-4xl font-bold mb-4" style="color: #edcc13;">
          Program Highlights
        </h2>
        <p class="text-gray-600 max-w-2xl mx-auto">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6 max-w-6xl mx-auto">
        ...
        <div class="bg-white p-6 rounded-xl shadow-lg text-center">
          <div class="w-12 h-12 bg-[#f7f3e3] rounded-full flex items-center justify-center mx-auto mb-4">
            <svg class="w-6 h-6" fill="none" stroke="#edcc13" viewBox="0 0 24 24">
  ...
  <section class="py-16 bg-gray-900 text-white">
    <div class="container mx-auto px-4">
      <div class="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-6xl mx-auto text-center">
        <div>
          <div class="text-4xl font-bold text-\[#edcc13\] mb-2">20+</div>
          <div class="text-gray-300">Years of Excellence</div>
        </div>
        <div>
          <div class="text-4xl font-bold text-\[#edcc13\] mb-2">15k+</div>
          <div class="text-gray-300">Students</div>
        </div>
        <div>
          <div class="text-4xl font-bold text-\[#edcc13\] mb-2">500+</div>
          <div class="text-gray-300">Faculty Members</div>
        </div>
        <div>
          <div class="text-4xl font-bold text-\[#edcc13\] mb-2">50+</div>
  ...
  <section class="py-16 bg-gray-50">
    <div class="container mx-auto px-4" use:inView>
      ...
      >
        <h2 class="text-3xl md:text-4xl font-bold text-\[#edcc13\] mb-4">
      ...
      <div class="grid md:grid-cols-2 gap-8 items-center">
        ...
        >
          <div class="flex items-center gap-4">
            <div class="rounded-full p-2 flex-shrink-0" style="background-color: #edcc13;">
  ...
  <section class="bg-gray-900 py-16">
    <div class="container mx-auto px-4">
      ...
      <div class="max-w-3xl mx-auto relative">
        <!-- Navigation Buttons -->
        <button 
          class="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-12 text-\[#edcc13\] hover:text-[#d4b312] transition-colors z-10"
        ...
        <button 
          class="absolute right-0 top-1/2 -translate-y-1/2 translate-x-12 text-\[#edcc13\] hover:text-[#d4b312] transition-colors z-10"
        ...
        <div class="text-center px-8 md:px-12">
          <div class="mb-8">
            <img 
              ...
              class="w-20 h-20 rounded-full mx-auto object-cover border-4 border-[#edcc13]"
            />
          </div>
          <h3 class="text-xl font-semibold mb-1" style="color: #edcc13;">Geeta Sharma</h3>
          <p class="text-gray-400 text-sm mb-6">Online MBA Graduate, Batch of 2024</p>
          <p class="text-gray-300 leading-relaxed">
            "The Online MBA program at Amity University exceeded my expectations. The flexibility 
            to learn while working full-time was crucial for my career growth. The interactive 
            live sessions, industry-relevant curriculum, and networking opportunities with 
            professionals across India made this journey incredibly rewarding. Within months of 
            completing the program, I secured a significant promotion at my organization."
          </p>
        </div>
      </div>
    </div>
